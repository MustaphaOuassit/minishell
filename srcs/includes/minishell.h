...
/*   Updated: 2021/12/20 20:30:31 by mouassit         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	initial_ex(char **token, char **token_word, int *len_dr, char **dollar);
...
int		continue_error(t_list *head, int error, t_envp *env, t_data **data);
